...
**Used by:** `/showcase`, `/showcase/beneath-the-surface`, and `/showcase/signal` — showcase pages need the header to scroll away for an immersive full-screen experience.
