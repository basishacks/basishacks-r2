    ...
    <div v-if="!showMain" class="boot-sequence">
      ...
      <div class="boot-lines">
        <p v-for="(line, i) in bootLines" :key="i" class="boot-line">
          <span v-if="line.startsWith('>')" class="prompt">█ </span>{{ line }}
    ...
    <div v-else class="main-content">
      ...
      <div class="asm-section">
        <div class="asm-block">
          ...
          <span class="asm-instr">MOV</span> <span class="asm-reg">AX</span>, 0x0026 <span class="asm-comment">; season 2, 2026</span>
          <span class="asm-instr">MOV</span> <span class="asm-reg">DS</span>, AX
          <span class="asm-instr">MOV</span> <span class="asm-reg">SI</span>, hackathon <span class="asm-comment">; ptr to event state</span>
          <span class="asm-instr">MOV</span> <span class="asm-reg">CX</span>, 0x0036 <span class="asm-comment">; 54 endpoints</span>
          <span class="asm-instr">REPZ</span> <span class="asm-reg">MOVSB</span> <span class="asm-comment">; load all routes</span>
          <span class="asm-instr">INT</span> <span class="asm-reg">0x21</span> <span class="asm-comment">; dispatch to Nitro</span>
        </div>
      </div>
    </div>
  </div>
