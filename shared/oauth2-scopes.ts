...
export const OAuth2Scopes: Record<string, OAuth2ScopeMeta> = {
  openid: { description: 'Access basic OpenID Connect identity information', adminOnly: false, sensitive: false},
  profile: { description: 'Access user profile information (name, picture, etc.)', adminOnly: false, sensitive: false },
  email: { description: "Access user's email address", adminOnly: false, sensitive: false },
  "meetings.read.application": { description: 'Reads meeting application bound to this application.', adminOnly: false, sensitive: false },
  "meetings.read.all": { description: 'Reads all meetings', adminOnly: true, sensitive: true },
  "meetings.readwrite.application": { description: 'Reads and writes meeting applications bound to this application.', adminOnly: false, sensitive: false },
  "meetings.readwrite.all": { description: 'Reads and writes all meetings', adminOnly: true, sensitive: true },
  "chat.read": { description: 'Read user chats', adminOnly: false, sensitive: true },
