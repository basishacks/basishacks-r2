...
export function addScopes(scopes: string | null | undefined, toAdd: string[]): string {
...
export function removeScope(scopes: string | null | undefined, toRemove: string): string {
