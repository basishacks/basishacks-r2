...
import type { TextareaProps, TextareaEmits, TextareaSlots } from '@nuxt/ui/components/Textarea.vue'
...
const slots = defineSlots<Pick<TextareaSlots, 'leading' | 'trailing' | 'default'>>()
