...
<template>
  ...
  >
    ...
    <UFormField name="project.demo_url" label="Demo URL">
      ...
      <template #help>
        This should allow anyone can experience your project. For more information, please review
        the hackathon rules.
      </template>
    </UFormField>
    ...
    <UFormField name="pathway" label="Pathway">
      ...
      <template #help>
        The junior pathway puts more emphasis on originality and creativity, while the senior
        pathway more on problem-solving and impact. You may choose any pathway, regardless of grade
        level.
      </template>
    </UFormField>
    ...
    <div class="flex gap-4">
      ...
      <UButton id="project-submit" :disabled="disabled" type="submit" @click="intent = 'submit'">
        Submit
      </UButton>
    </div>
  </UForm>
