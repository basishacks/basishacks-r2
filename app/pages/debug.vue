    ...
    <div v-if="activeTab === 'upload'">
      ...
      <form class="space-y-4" @submit.prevent="uploadFile">
        ...
        <div class="flex items-center">
          <input id="keepName" v-model="keepOriginalName" type="checkbox" class="w-4 h-4" />
        ...
        <div class="grid gap-6 md:grid-cols-2">
          <div class="rounded border border-slate-200 p-4 bg-slate-50">
            ...
            <ul class="space-y-2">
              ...
              <li v-else-if="fileLists.assets.length === 0" class="text-sm text-slate-500">
          ...
          <div class="rounded border border-slate-200 p-4 bg-slate-50">
            ...
            <ul class="space-y-2">
              ...
              <li v-else-if="fileLists.userast.length === 0" class="text-sm text-slate-500">
