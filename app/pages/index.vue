...
const themeDescription = computed(() => hackathon.value.theme_description || "");
</script>
...
<template>
    <div class="mt-4">
        ...
        <p class="mb-4">
            ...
            ), a week where creativity meets technology, where ideas transform into prototypes, and
        ...
        <template v-else>
            ...
            <p class="mb-4 whitespace-pre-wrap">{{ themeDescription }}</p>
        </template>
