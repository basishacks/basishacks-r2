          ...
          <Transition name="fade">
            ...
            >
              ...
              >
                ...
                <UButton :disabled="isLoading" type="submit">Send verification code</UButton>
              </UForm>
          ...
          <Transition name="fade">
            ...
            >
              ...
              >
                ...
                <span class="text-sm">
                  A
                  <span class="text-primary bold">6-digit</span>
                  verification code has been sent to your
                  <ULink
                    class="text-primary bold inline"
          ...
          <Transition name="fade">
            ...
            >
              ...
              <div>
                ...
                <p
                  v-if="
                    usedScopes.includes('openid') ||
                    usedScopes.includes('profile') ||
                    usedScopes.includes('email')
                  "
    ...
    await withLoadingIndicator(async () => {
      const res: any = await $fetch('/api/auth/login', {
        ...
        body: {
          ...
          code,
          token: sessionStorage.getItem('oauth2_token') || '',
        },
      });
      userId.value = res.id;
