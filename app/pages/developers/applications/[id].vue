          ...
          <UCard v-else-if="activeTab === 'authorization'">
            ...
            <div class="space-y-8">
              ...
              <div class="space-y-4">
                ...
                <div v-if="secretsStatus === 'pending'" class="flex justify-center py-8">
                  <LoaderAnimationInline :show="true" />
                </div>
              ...
              <div class="space-y-4">
                ...
                <div v-if="redirectUrisStatus === 'pending'" class="flex justify-center py-8">
                  <LoaderAnimationInline :show="true" />
                </div>
    ...
    <template #content>
      <UCard>
        ...
        <div class="flex gap-2">
          ...
          <UButton icon="i-lucide-copy" color="neutral" variant="outline" @click="copySecret" />
        </div>

        <template #footer>
          <div class="flex justify-end">
            <UButton color="neutral" variant="outline" @click="newSecretModalOpen = false">
              Close
            </UButton>
          </div>
        </template>
