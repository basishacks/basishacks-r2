...
<template>
    <div class="mt-4">
        ...
        <p class="mb-4">
            You will see four projects below. Please distribute 12 stars among them. Each project
            must receive 1-5 stars, and you must use all of them. Please also write a short
            paragraph justifying your vote. Make sure you include details about ALL four projects!
        </p>
