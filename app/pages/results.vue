      ...
      <Transition name="slide-right">
        <div v-if="team1showDescriptionRef" class="team1-description transition-content">
          ...
          <p class="mt-16 text-neutral-400">
            ... by 6 scenes, the player can experience the story of a fallen civilization and a
            blade of grass in a fading world seeking self-redemption
          </p>
          <p class="mt-4 text-neutral-400">
            In this chaotic time, Syl tries to give herself purpose by delivering the mail
            "feather", imitating a predecessor.
          </p>
          <p class="mt-4 text-white">
            If the player pays more attention to the surroundings while playing, they may discover
            and reveal a hidden truth of that world
          </p>
      ...
      <div class="max-h-[20vh] xl:min-h-screen flex flex-col justify-center w-full">
        <div class="flex flex-col items-center justify-center">
          ...
          <p class="z-3 w-max-2 mx-50vw text-center px-8">
            A robotic head that looks cool and is able to recognize learned faces and colors, and
            provide personalized reactions
          </p>
  ...
  >
    ...
    >
      ...
      <p class="text-gray-300 mt-8">
        Dysarthria is a motor speech disorder that affects the muscles we use for speaking, making
        speech difficult to understand, especially for traditional speech systems like Apple Siri.
      </p>

      <p class="text-gray-300 mt-8">
        This project bridges the gap for speakers with dysarthria by using a fine-tuned HuBERT-large
        model to accurately classify essential voice commands.
      </p>
