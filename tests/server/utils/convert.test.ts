...
describe("convert utilities", () => {
    ...
    it("convertUserToPublic returns null for null name", () => {
        const user: any = {
            id: 1, email: "a@b.com", role: "participant",
            name: null, team_id: 5, profile_theme: null, profile_picture: null,
        };
    ...
    it("convertUserToPublic returns null for null team_id", () => {
        const user: any = {
            id: 2, email: "b@c.com", role: "participant",
            name: "Bob", team_id: null, profile_theme: null, profile_picture: null,
        };
    ...
    it("convertUserToPublic returns emoji fallback for null profile_theme", () => {
        const user: any = {
            id: 3, email: "c@d.com", role: "participant",
            name: "Carol", team_id: 1, profile_theme: null, profile_picture: null,
        };
    ...
    it("convertUserToPublic returns null for null profile_picture", () => {
        const user: any = {
            id: 4, email: "d@e.com", role: "participant",
            name: "Dave", team_id: 2, profile_theme: "url|img.png", profile_picture: null,
        };
    ...
    it("convertUserToPublic parses profile_theme mode url|value", () => {
        const user: any = {
            id: 5, email: "e@f.com", role: "participant",
            name: "Eve", team_id: 3, profile_theme: "url|https://cdn.example.com/avatar.png",
            profile_picture: null,
        };
        expect(convertUserToPublic(user).profile_theme).toEqual({
            mode: "url", value: "https://cdn.example.com/avatar.png",
        });
    });

    it("convertUserToPublic parses profile_theme mode emoji|value", () => {
        const user: any = {
            id: 6, email: "f@g.com", role: "participant",
            name: "Frank", team_id: 4, profile_theme: "emoji|🚀",
            profile_picture: null,
        };
        expect(convertUserToPublic(user).profile_theme).toEqual({ mode: "emoji", value: "🚀" });
    });
    ...
    it("convertUserToPublic parses profile_theme mode gradient|value", () => {
        const user: any = {
            id: 7, email: "g@h.com", role: "participant",
            name: "Grace", team_id: 5, profile_theme: "gradient|#667eea-#764ba2",
            profile_picture: null,
        };
        expect(convertUserToPublic(user).profile_theme).toEqual({
            mode: "gradient", value: "#667eea-#764ba2",
        });
    });

    it("convertUserToPublic falls back to emoji for empty profile_theme string", () => {
        const user: any = {
            id: 8, email: "h@i.com", role: "participant",
            name: "Heidi", team_id: 6, profile_theme: "",
            profile_picture: null,
        };
        expect(convertUserToPublic(user).profile_theme).toEqual({ mode: "emoji", value: "" });
    });
    ...
    it("convertUserToPublic handles undefined profile_theme", () => {
        const user: any = {
            id: 9, email: "i@j.com", role: "participant",
            name: "Ivan", team_id: 7, profile_picture: null,
        };
    ...
    it("convertUserToPublic preserves email", () => {
        const user: any = {
            id: 10, email: "preserved@test.com", role: "participant",
            name: "Judy", team_id: 8, profile_theme: null, profile_picture: null,
        };
    ...
    it("convertUserToPublic preserves role participant", () => {
        const user: any = {
            id: 11, email: "k@l.com", role: "participant",
            name: "Karl", team_id: 9, profile_theme: null, profile_picture: null,
        };
    ...
    it("convertUserToPublic preserves role admin", () => {
        const user: any = {
            id: 12, email: "m@n.com", role: "admin",
            name: "Mallory", team_id: 10, profile_theme: null, profile_picture: null,
        };
    ...
    it("convertUserToPublic preserves role judge", () => {
        const user: any = {
            id: 13, email: "o@p.com", role: "judge",
            name: "Oscar", team_id: 11, profile_theme: null, profile_picture: null,
        };
    ...
    it("convertUserToPublic keeps id as number", () => {
        const user: any = {
            id: 99, email: "q@r.com", role: "participant",
            name: "Peggy", team_id: 12, profile_theme: null, profile_picture: null,
        };
        const result = convertUserToPublic(user);
    ...
    it("convertUserToPublic handles empty string name", () => {
        const user: any = {
            id: 14, email: "s@t.com", role: "participant",
            name: "", team_id: 13, profile_theme: null, profile_picture: null,
        };
    ...
    it("convertUserToPublic preserves profile_picture string value", () => {
        const user: any = {
            id: 15, email: "u@v.com", role: "participant",
            name: "Sybil", team_id: 14, profile_theme: null,
    ...
    it("convertUserToPublic preserves team_id as number", () => {
        const user: any = {
            id: 16, email: "w@x.com", role: "participant",
            name: "Trent", team_id: 42, profile_theme: null, profile_picture: null,
        };
        const result = convertUserToPublic(user);
    ...
    it("convertUserToPublic includes all expected fields", () => {
        const user: any = {
            id: 17, email: "y@z.com", role: "participant",
            name: "Walter", team_id: 15, profile_theme: "emoji|🔥",
    ...
    it("convertTeamToPublic project_submitted=0 coerces to false", () => {
        const team: any = {
            id: 10, name: "Team J", pathway: "senior", rank: 1, score: 100,
            season_id: 1, project_name: "P", project_description: "D",
            project_demo_url: null, project_repo_url: null,
            project_submitted: 0, sourcing: "",
        };
    ...
    it("convertTeamToPublic project_submitted=1 coerces to true", () => {
        const team: any = {
            id: 11, name: "Team K", pathway: "junior", rank: 2, score: 90,
            season_id: 1, project_name: "Q", project_description: "E",
            project_demo_url: "https://demo", project_repo_url: "https://repo",
            project_submitted: 1, sourcing: "internal",
        };
    ...
    it("convertTeamToPublic returns null demo_url", () => {
        const team: any = {
            id: 12, name: "Team L", pathway: "senior", rank: null, score: null,
            season_id: 1, project_name: "R", project_description: "F",
            project_demo_url: null, project_repo_url: "https://repo",
            project_submitted: 1, sourcing: null,
        };
    ...
    it("convertTeamToPublic returns null repo_url", () => {
        const team: any = {
            id: 13, name: "Team M", pathway: "junior", rank: null, score: null,
            season_id: 1, project_name: "S", project_description: "G",
            project_demo_url: "https://demo", project_repo_url: null,
            project_submitted: 1, sourcing: null,
        };
    ...
    it("convertTeamToPublic with withScore=true shows score and no awards", () => {
        const team: any = {
            id: 14, name: "Team N", pathway: "senior", rank: 3, score: 85,
            season_id: 1, project_name: "T", project_description: "H",
            project_demo_url: null, project_repo_url: null,
            project_submitted: 0, sourcing: null,
        };
        const result = convertTeamToPublic(team, true);
    ...
    it("convertTeamToPublic without withScore flag defaults score to null", () => {
        const team: any = {
            id: 15, name: "Team O", pathway: "junior", rank: 4, score: 80,
            season_id: 1, project_name: "U", project_description: "I",
            project_demo_url: null, project_repo_url: null,
            project_submitted: 0, sourcing: null,
        };
    ...
    it("convertTeamToPublic with neither score nor awards", () => {
        const team: any = {
            id: 16, name: "Team P", pathway: "senior", rank: null, score: null,
            season_id: 1, project_name: "V", project_description: "J",
            project_demo_url: null, project_repo_url: null,
            project_submitted: 0, sourcing: null,
        };
        const result = convertTeamToPublic(team, true);
    ...
    it("convertTeamToPublic handles multiple awards", () => {
        const team: any = {
            id: 17, name: "Team Q", pathway: "junior", rank: 1, score: 95,
            season_id: 1, project_name: "W", project_description: "K",
            project_demo_url: "https://demo", project_repo_url: "https://repo",
            project_submitted: 1, sourcing: "docs",
        };
        const awards = [
    ...
    it("convertTeamToPublic handles empty awards array", () => {
        const team: any = {
            id: 18, name: "Team R", pathway: "senior", rank: 2, score: 70,
            season_id: 1, project_name: "X", project_description: "L",
            project_demo_url: null, project_repo_url: null,
            project_submitted: 1, sourcing: null,
        };
    ...
    it("convertTeamToPublic returns null sourcing", () => {
        const team: any = {
            id: 19, name: "Team S", pathway: "junior", rank: null, score: null,
            season_id: 1, project_name: "Y", project_description: "M",
            project_demo_url: null, project_repo_url: null,
            project_submitted: 0, sourcing: null,
        };
    ...
    it("convertTeamToPublic handles all null project fields", () => {
        const team: any = {
            id: 20, name: "Team T", pathway: "senior", rank: null, score: null,
            season_id: 1, project_name: null, project_description: null,
            project_demo_url: null, project_repo_url: null,
            project_submitted: 0, sourcing: null,
        };
        const result = convertTeamToPublic(team);
    ...
    it("convertTeamToPublic preserves pathway junior", () => {
        const team: any = {
            id: 21, name: "Team U", pathway: "junior", rank: null, score: null,
            season_id: 1, project_name: null, project_description: null,
            project_demo_url: null, project_repo_url: null,
            project_submitted: 0, sourcing: null,
        };
    ...
    it("convertTeamToPublic preserves pathway senior", () => {
        const team: any = {
            id: 22, name: "Team V", pathway: "senior", rank: null, score: null,
            season_id: 1, project_name: null, project_description: null,
            project_demo_url: null, project_repo_url: null,
            project_submitted: 0, sourcing: null,
        };
    ...
    it("convertTeamToPublic returns null rank", () => {
        const team: any = {
            id: 23, name: "Team W", pathway: "junior", rank: null, score: null,
            season_id: 1, project_name: "Z", project_description: "N",
            project_demo_url: null, project_repo_url: null,
            project_submitted: 0, sourcing: null,
        };
    ...
    it("convertTeamToPublic returns null project_name", () => {
        const team: any = {
            id: 24, name: "Team X", pathway: "senior", rank: 5, score: 60,
            season_id: 1, project_name: null, project_description: "O",
            project_demo_url: null, project_repo_url: null,
            project_submitted: 1, sourcing: "",
        };
    ...
    it("convertTeamToPublic returns null project_description", () => {
        const team: any = {
            id: 25, name: "Team Y", pathway: "junior", rank: 6, score: 55,
            season_id: 1, project_name: "Zeta", project_description: null,
            project_demo_url: null, project_repo_url: null,
            project_submitted: 1, sourcing: "",
        };
    ...
    it("convertTeamToPublic includes all expected team fields", () => {
        const team: any = {
            id: 26, name: "Team Z", pathway: "senior", rank: 7, score: 75,
            season_id: 1, project_name: "P", project_description: "D",
            project_demo_url: "https://demo", project_repo_url: "https://repo",
            project_submitted: 1, sourcing: "git",
        };
        const result = convertTeamToPublic(team, true);
        expect(result).toHaveProperty("id");
        expect(result).toHaveProperty("name");
    ...
    it("parseProfileTheme invalid mode falls back to emoji", () => {
        const user: any = {
            id: 100, email: "inval@id.com", role: "participant",
            name: "Inv", team_id: null, profile_theme: "invalid|somevalue",
            profile_picture: null,
        };
        expect(convertUserToPublic(user).profile_theme).toEqual({ mode: "emoji", value: "somevalue" });
    });

    it("parseProfileTheme string without pipe separator falls back to emoji with empty value", () => {
        const user: any = {
            id: 101, email: "no@p.pe", role: "participant",
            name: "NoPipe", team_id: null, profile_theme: "justtext",
            profile_picture: null,
        };
        expect(convertUserToPublic(user).profile_theme).toEqual({ mode: "emoji", value: "" });
    });
    ...
    it("parseProfileTheme empty after pipe keeps value as empty string", () => {
        const user: any = {
            id: 102, email: "empty@val.com", role: "participant",
            name: "EmptyVal", team_id: null, profile_theme: "url|",
            profile_picture: null,
        };
    ...
    it("parseProfileTheme gradient with complex value", () => {
        const user: any = {
            id: 103, email: "grad@ient.com", role: "participant",
            name: "Grad", team_id: null, profile_theme: "gradient|linear-gradient(45deg, #f00 0%, #00f 100%)",
            profile_picture: null,
        };
        expect(convertUserToPublic(user).profile_theme).toEqual({
            mode: "gradient",
